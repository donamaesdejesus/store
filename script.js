...
Vue.component('products', {
  ...
  template: "<h1>Lightstick Lists</h1> " + 
  "<div class='products'>" +
  ...
  data: {
    productsData: [
     ...
     { sku: 12,
      ...
      { sku: 18,
        product: "SHINEE",
        image: "https://cf.shopee.ph/file/6d538f9ee0bd2f1cb063ff5a1a5a5342",
        description: "Official Shinee Lightstick",
      ...
      { sku: 19,
        product: "PENTAGON",
        image: "https://kpopmerchandiseguide.com/image/pentagon-official-light-stick-uni-bong.jpg",
        description: "Official Pentagon Lightstick",
      ...
      { sku: 20,
        product: "SF9",
        image: "https://kpopmerchandiseguide.com/image/sf9-official-light-stick-jigu-bong.jpg",
        description: "Official SF9 Lightstick",
